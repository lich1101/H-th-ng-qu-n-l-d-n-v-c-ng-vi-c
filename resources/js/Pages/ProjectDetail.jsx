                            ...
                            <div className="rounded-2xl bg-slate-50 px-4 py-3">
                                ...
                                <div className="mt-1 flex items-center gap-2">
                                    <div className="h-2 flex-1 rounded-full bg-slate-200">
                                        <div className={`h-2 rounded-full ${progressBarFillClass(project.progress_percent)} transition-all`} style={{ width: `${Math.max(0, Math.min(100, Number(project.progress_percent) || 0))}%` }} />
                                    </div>
