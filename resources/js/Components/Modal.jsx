    ...
    return (
        ...
        >
            <div
                ...
                className={`relative w-full ${sizeClass} max-h-[90vh] rounded-3xl bg-white border border-slate-200/80 shadow-[0_30px_80px_rgba(15,23,42,0.22)] flex flex-col overflow-visible`}
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto overflow-x-visible px-7 py-7 md:px-10 md:py-9">{children}</div>
            </div>
        </div>
    );
}
