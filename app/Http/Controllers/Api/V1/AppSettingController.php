...
class AppSettingController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'client_rotation_comment_stale_days' => ['nullable', 'integer', 'min:0', 'max:3650'],
            'client_rotation_opportunity_stale_days' => ['nullable', 'integer', 'min:0', 'max:3650'],
            'client_rotation_contract_stale_days' => ['nullable', 'integer', 'min:0', 'max:3650'],
            'client_rotation_warning_days' => ['nullable', 'integer', 'min:0', 'max:60'],
            'client_rotation_daily_receive_limit' => ['nullable', 'integer', 'min:0', 'max:100'],
            'client_rotation_pool_claim_daily_limit' => ['nullable', 'integer', 'min:0', 'max:100'],
