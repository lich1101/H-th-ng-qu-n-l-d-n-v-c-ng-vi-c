...
class LeadFormController extends Controller
{
    ...
    private function validatePayload(Request $request, ?LeadForm $leadForm = null): array
    {
        ...
        $validator = Validator::make($payload, [
            ...
            'style_config.loading_text' => ['nullable', 'string', 'max:60'],
            'style_config.success_title' => ['nullable', 'string', 'max:100'],
            'style_config.success_message' => ['nullable', 'string', 'max:255'],
            'style_config.success_icon_url' => ['nullable', 'string', 'max:500'],
