...
class AppSetting extends Model
{
    protected $fillable = [
        ...
        'client_rotation_pool_claim_daily_limit',
    ...
    protected $casts = [
        ...
        'client_rotation_pool_claim_daily_limit' => 'integer',
        'client_rotation_run_time' => 'string',
    ...
    public static function defaults(): array
    {
        return [
            ...
            'client_rotation_pool_claim_daily_limit' => 5,
            'client_rotation_run_time' => '12:00',
            'client_rotation_lead_type_ids' => [],
            'client_rotation_participant_user_ids' => [],
